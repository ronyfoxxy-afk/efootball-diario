...
const S: any = {
  ...
  btnPri:  { background: G.blue, color: '#fff', border: 'none', borderRadius: 8, padding: '10px 18px', fontSize: 12, fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase' as const, cursor: 'pointer', fontFamily: 'inherit', fontFamily: "'Barlow Condensed',sans-serif" },
