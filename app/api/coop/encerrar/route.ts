...
export async function GET(req: NextRequest) {
  ...
  if (sala) {
    ...
    if (!data || data.length === 0) {
      return new NextResponse(
        `<html><body style="background:#07090e;color:#f59e0b;font-family:sans-serif;display:flex;align-items:center;justify-content:center;height:100vh;margin:0;font-size:18px;text-align:center;flex-direction:column;gap:10px;">⚠️<br>Fila vazia</body></html>`,
  ...
  return new NextResponse(
    `<html><body style="background:#07090e;color:#00d084;font-family:sans-serif;display:flex;align-items:center;justify-content:center;height:100vh;margin:0;font-size:20px;font-weight:700;text-align:center;flex-direction:column;gap:12px;">✅<br>Sala #${salaEncerrada} encerrada!<br><span style="font-size:13px;color:#4e5d72;margin-top:8px;">Pode fechar essa aba</span></body></html>`,
    { headers: { 'Content-Type': 'text/html' } }
  )
}
