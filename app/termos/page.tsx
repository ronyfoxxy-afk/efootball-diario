  ...
  return (
    <div style={{ minHeight:'100vh', background:'#09090b' }}>
      ...
      <main style={{ maxWidth:760, margin:'0 auto', padding:'2rem 1rem 4rem' }}>
        <h1 style={{ fontFamily:"'Barlow Condensed',sans-serif", fontWeight:900, fontSize:36, color:'#e8b84b', textTransform:'uppercase', letterSpacing:1, marginBottom:'0.5rem' }}>Termos de Uso</h1>
